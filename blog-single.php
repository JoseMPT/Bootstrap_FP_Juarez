                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <div class="blog-author d-flex align-items-center">
                            <img alt="" class="rounded-circle float-left" src="assets/img/blog/blog-author.jpg">
                            <div>
                                <h4>Jane Smith</h4>
                        ...
                        <div class="blog-comments">
                            ...
                            <div class="comment" id="comment-1">
                                <div class="d-flex">
                                    <div class="comment-img"><img alt="" src="assets/img/blog/comments-1.jpg"></div>
                                    <div>
                                        <h5><a href="">Georgia Reader</a> <a class="reply" href="#"><i
                            ...
                            <div class="comment" id="comment-2">
                                <div class="d-flex">
                                    <div class="comment-img"><img alt="" src="assets/img/blog/comments-2.jpg"></div>
                                    <div>
                                        <h5><a href="">Aron Alvarado</a> <a class="reply" href="#"><i
                                                class="bi bi-reply-fill"></i> Reply</a></h5>
                                        <time datetime="2020-01-01">01 Jan, 2020</time>
                                        <p>
                                ...
                                <div class="comment comment-reply" id="comment-reply-1">
                                    <div class="d-flex">
                                        <div class="comment-img"><img alt="" src="assets/img/blog/comments-3.jpg"></div>
                                        <div>
                                            <h5><a href="">Lynda Small</a> <a class="reply" href="#"><i
                                                    class="bi bi-reply-fill"></i> Reply</a></h5>
                                            <time datetime="2020-01-01">01 Jan, 2020</time>
                                            <p>
                                    ...
                                    <div class="comment comment-reply" id="comment-reply-2">
                                        <div class="d-flex">
                                            <div class="comment-img"><img alt="" src="assets/img/blog/comments-4.jpg">
                                            </div>
                                            <div>
                                                <h5><a href="">Sianna Ramsay</a> <a class="reply" href="#"><i
                                                        class="bi bi-reply-fill"></i> Reply</a></h5>
                                                <time datetime="2020-01-01">01 Jan, 2020</time>
                                                <p>
                            ...
                            <div class="comment" id="comment-3">
                                <div class="d-flex">
                                    <div class="comment-img"><img alt="" src="assets/img/blog/comments-5.jpg"></div>
                                    <div>
                                        <h5><a href="">Nolan Davidson</a> <a class="reply" href="#"><i
                                                class="bi bi-reply-fill"></i> Reply</a></h5>
                                        <time datetime="2020-01-01">01 Jan, 2020</time>
                                        <p>
                            ...
                            <div class="comment" id="comment-4">
                                <div class="d-flex">
                                    <div class="comment-img"><img alt="" src="assets/img/blog/comments-6.jpg"></div>
                                    <div>
                                        <h5><a href="">Kay Duggan</a> <a class="reply" href="#"><i
                                                class="bi bi-reply-fill"></i> Reply</a></h5>
                                        <time datetime="2020-01-01">01 Jan, 2020</time>
                                        <p>
                                ...
                                <form action="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input class="form-control" id="correo" name="email"
